...
#define CLK_PIN 12 // ESP32 pin GPIO25 connected to the rotary encoder's CLK pin
#define DT_PIN  13 // ESP32 pin GPIO26 connected to the rotary encoder's DT pin
